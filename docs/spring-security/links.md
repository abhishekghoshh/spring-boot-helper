...
- [Spring Security 6 Zero to Master along with JWT,OAUTH2](https://www.udemy.com/course/spring-security-zero-to-master)
...
- [Spring Security with ReactJS, OAuth2, JWT, MFA | Spring Boot](https://www.udemy.com/course/spring-security-6-with-reactjs-oauth2-jwt-multifactor-authentication/)
...
- [Master SAML 2.0 with Okta](https://www.udemy.com/course/master-saml-with-okta)
...
- [Concept && Coding - by Shrayansh](https://www.youtube.com/@ConceptAndCodingByShrayansh)
  ...
  - [Spring boot: Security (Part-2) | Multiple User Creation & Storing Username & Password | inMemory, DB](https://www.youtube.com/watch?v=koWPxSy-2_A)
  - [Spring boot: Security (Part-3) | Form Based Authentication & Authorization | Stateful Authentication](https://www.youtube.com/watch?v=CceqMR-NAOE)
  - [Spring boot: Security (Part-4) | Basic Authentication & Authorization | Stateless Authentication](https://www.youtube.com/watch?v=F0OanpXM3aQ)
  ...
  - [Spring boot: Security (Part-6) | JWT Authentication Implementation | JSON Web Token Implementation](https://www.youtube.com/watch?v=j0T1loqQzHw)
  ...
  - [Spring boot: Security (Part-8) | OAUTH2 Authentication Implementation](https://www.youtube.com/watch?v=jBgPkOiZ6rk)
  - [Spring boot: Security (Part-8) | OAUTH2 Authentication Implementation](https://www.youtube.com/watch?v=jBgPkOiZ6rk)
  - [Spring boot: Security (Part-9) | Method Security | Role based Authorization | @PreAuthorize and Post](https://www.youtube.com/watch?v=I5nU_R_UnUw)

- [CodeSnippet](https://www.youtube.com/@CodeSnippetByChetanGhate)
    - [Spring Security](https://www.youtube.com/playlist?list=PL-bgVzzRdaPgUNCr1cQE_ZLKf5oJaZP4R)

- [Daily Code Buffer](https://www.youtube.com/@DailyCodeBuffer)
    - [Spring Security 6 with Spring Boot 3 and JWT Tutorial](https://www.youtube.com/watch?v=oQV2WGin0mc)
...
- [Full Stack Spring Boot React - OAuth2 Login with Google & Microsoft](https://www.youtube.com/watch?v=fE-jZmqMFog)
- [Complete OAuth2 Course with Spring Boot & React | GitHub & Google Integration Step By Step Tutorial](https://www.youtube.com/watch?v=JUOSHhbbBOY)
...
- [Spring Boot Security - JWT Refresh Token Explained In Details | JavaTechie](https://www.youtube.com/watch?v=Wp4h_wYXqmU)
- [JWT Authentication with Refresh Tokens | Spring Security 6 Tutorial](https://www.youtube.com/watch?v=OKMRSOLvUf8)
- [Spring Security - Refresh token](https://www.youtube.com/watch?v=EsVybSJr7zU)
...
### Spring security with Resource Server, JWT, MongoDB
