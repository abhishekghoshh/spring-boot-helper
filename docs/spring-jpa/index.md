...
- [003 - EntityManagerFactory and EntityManager](./003-entity-manager-factory-and-entity-manager.md)
- [004 - Persistence Context](./004-persistence-context.md)
- [005 - Transaction Manager](./005-transaction-manager.md)
- [006 - Hibernate Implementation](./006-hibernate-implementation.md)
- [007 - How JPA Repository Uses EntityManager](./007-how-jpa-repository-uses-entity-manager.md)
- [008 - Why @PersistenceContext Instead of @Autowired](./008-persistence-context-annotation-vs-autowired.md)
- [009 - Why @Transactional is Used for EntityManager](./009-transactional-with-entity-manager.md)
- [010 - How EntityManager Creates Persistence Context](./010-entity-manager-creates-persistence-context.md)
- [011 - Role of Persistence Context](./011-role-of-persistence-context.md)
- [012 - Transaction-Bounded Operations](./012-transaction-bounded-operations.md)
- [013 - First-Level Caching](./013-first-level-caching.md)
- [014 - Second-Level Caching](./014-second-level-caching.md)
- [015 - spring.jpa.hibernate.ddl-auto](./015-ddl-auto.md)
- [016 - @Table Annotation](./016-table-annotation.md)
- [017 - @Column Annotation](./017-column-annotation.md)
- [018 - @Id Annotation and Composite IDs](./018-id-and-composite-ids.md)
- [019 - @SequenceGenerator](./019-sequence-generator.md)
- [020 - @GeneratedValue and Generation Strategies](./020-generated-value-and-generation-strategies.md)
- [021 - OneToOne Unidirectional Mapping](./021-one-to-one-unidirectional-mapping.md)
- [022 - Eager and Lazy Loading](./022-eager-and-lazy-loading.md)
- [023 - OneToOne Bidirectional Mapping](./023-one-to-one-bidirectional-mapping.md)
- [024 - OneToMany Unidirectional Mapping](./024-one-to-many-unidirectional-mapping.md)
- [025 - OneToMany Bidirectional Mapping](./025-one-to-many-bidirectional-mapping.md)
- [026 - ManyToOne Bidirectional Mapping](./026-many-to-one-bidirectional-mapping.md)
- [027 - ManyToMany Unidirectional Mapping](./027-many-to-many-unidirectional-mapping.md)
- [028 - ManyToMany Bidirectional Mapping](./028-many-to-many-bidirectional-mapping.md)
- [029 - Derived Query Methods](./029-derived-query-methods.md)
- [030 - JPQL](./030-jpql.md)
- [031 - The N+1 Problem in JPA](./031-n-plus-1-problem.md)
- [032 - @NamedQuery](./032-named-query.md)
- [033 - Native Query](./033-native-query.md)
- [034 - Dynamic Native Query](./034-dynamic-native-query.md)
- [035 - Criteria API](./035-criteria-api.md)
- [036 - JPA Specification API](./036-jpa-specification-api.md)
...
- [Spring Boot and JPA Deep Dive: 25 Practical Interview Questions](https://codefarm0.medium.com/spring-boot-and-jpa-deep-dive-25-practical-interview-questions-4ee3cf068271)
...
- [Spring Data JPA & Transactions- Comprehensive questions list for interviews and conceptual understanding](https://codefarm0.medium.com/spring-data-jpa-transactions-comprehensive-questions-list-for-interviews-and-conceptual-6690e5e219ae)
- 
- 
